...
<html lang="en">
    <head>
        ...
        <link rel="manifest" href="somachord.webmanifest" />
        <link rel="stylesheet" href="somachord.css" />
    ...
    <body id="somachord-body" data-nosnippet>
        ...
        <div id="somachord-main-box" class="center box" style="visibility: hidden;">
